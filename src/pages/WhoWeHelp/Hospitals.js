import '../WhoWeHelp/hospital.css';
import React, { useEffect } from 'react';
import { useNavigate } from 'react-router-dom';

import HospitalHero from "../WhoWeHelp/WWHImages/Hospital.jpg";
import ImproveCashflowImg from "../WhoWeHelp/WWHImages/Readmissions.jpg";
...
import TestimonialPhoto from "../WhoWeHelp/WWHImages/Drjanki.webp"; // Replace with your actual image path
...
const whyUsTextBlocks = [
  {
    heading: "🔄 Reduced readmissions",
    text: "Our platform helps your teams manage post-discharge care more effectively, leading to fewer avoidable readmissions and better patient outcomes—critical for value-based care models."
  },
  {
    heading: "Seamless integration 🔗",
    text: "Integrates with your existing EHR and care management systems, automatically triggering follow-ups, RPM setup, and care plan updates without extra training or steps. "
  },
  {
    heading: "🧠 Data-Driven Care Coordination",
    text: "Clinical teams can access dashboards that highlight deteriorating trends, prioritize patient needs, and manage large caseloads efficiently through automated workflows."
  }
];
  ...
  <>
    <section className="hospital-hero">
      <div className="hospital-hero-left">
        <span className="hospital-hero-small">Hospitals & Health Systems</span>
        <h1 className="hospital-hero-title">Extend Your Reach Reduce Readmissions </h1>
        <p className="hospital-hero-desc">
          Our platform supports hospitals in delivering continuous care after discharge. With automated monitoring, real-time alerts, and staff-assisted care plans, you can improve outcomes without increasing workload. 
        </p>
        <button className="hospital-hero-btn" onClick={() => navigate('/contact')}>
          Book a Demo
        </button>
      </div>
