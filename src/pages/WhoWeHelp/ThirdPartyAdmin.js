...
import HospitalHero from "../WhoWeHelp/WWHImages/TPA.jpg";
...
const whyUsTextBlocks = [
  {
    heading: "🧰 Turnkey Chronic Care Services",
  ...
  {
    heading: "Boosted Employer Value 📈",
  ...
  <>
    <section className="hospital-hero">
      <div className="hospital-hero-left">
        <span className="hospital-hero-small">Third Party Administrator</span>
        <h1 className="hospital-hero-title">Streamlined <br/>chronic care, delivered</h1>
